...
<head>
    ...
    <title>Sign Up | Jeko Credit Federal Union (JEKOCFU)</title>

    <meta name="description" content="Sign Up | Jeko Credit Federal Union (JEKOCFU)">
    <meta name="author" content="pixelcave">
    <meta name="robots" content="noindex, nofollow">

    <!-- Open Graph Meta -->
    <meta property="og:title" content="Sign Up | Jeko Credit Federal Union (JEKOCFU)">
    <meta property="og:site_name" content="Jeko Credit Federal Union (JEKOCFU)">
    <meta property="og:description" content="Sign Up | Jeko Credit Federal Union (JEKOCFU)">
                        ...
                        <div class="p-3 w-100">
                            ...
                            <div class="mb-3 text-center">
                                <a class="text-success font-w700 font-size-h1" href="index.php">
                                    <!-- <span class="text-dark">Jeko Credit Federal Union (JEKOCFU) </span><span class="text-success">Bank</span> -->
                                    ...
                                    <form action="./handler/user_handler.php" method="POST">
                                        <div class="py-3">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" class="form-control form-control form-control-alt form-input-cus" name="fullname">
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="form-label">Username</label>
                                                <input required type="text" class="form-control form-control form-control-alt form-input-cus" name="username">
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="form-label">Phone</label>
                                                <input required type="text" class="form-control form-control form-control-alt form-input-cus" name="phone">
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="form-label">Email</label>
                                                <input required type="email" class="form-control form-control form-control-alt form-input-cus" name="email">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required name="address" class="form-control form-control form-control-alt form-input-cus" />
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="form-label">Date of birth</label>
                                                <input required type="date" title="Date of Birth" class="form-control form-control form-control-alt form-input-cus" name="dob">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required type="password" class="form-control form-control-lg form-control-alt form-input-cus" name="password">
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="form-label">Confirm Password</label>
                                                <input required type="password" class="form-control form-control-lg form-control-alt form-input-cus" name="confirm_pwd">
                                            </div>
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox custom-control-primary">
                                                    <input required type="checkbox" class="custom-control-input" required id="signup-terms" name="terms">
