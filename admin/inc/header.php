                ...
                <div class="content-header bg-white-10">
                    ...
                    <a class="font-w600 text-white tracking-wide" href="index.php">
                        ...
                        <span class="smini-hidden">
                            (JEKOCFU)<span class="opacity-75">Bank</span>
                        </span>
                    </a>
                    <!-- END Logo -->
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="all-transaction.php">
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./generate-manual-history.php">
                                        <span class="nav-main-link-name">Generate History</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./view-history.php">
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./download-history.php">
                                        <span class="nav-main-link-name">Download History</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./upload-history.php">
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./view-pdf-history.php">
                                        <span class="nav-main-link-name">View History</span>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./senders.php">
                                        <span class="nav-main-link-name">Set Config</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./view-senders.php">
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./error-page.php">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" aria-haspopup="true" aria-expanded="false" href="./tickets.php">
