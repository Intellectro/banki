...
<head>
  ...
  <title>Privacy Policy | Jeko Credit Federal Union (JEKOCFU)</title>
                        ...
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="privacy-policy">
                            ...
                            <table border="3" cellpadding="1" cellspacing="1" class="unstriped" role="presentation">
                              <caption class="sr-only">WHAT DOES JEKO Federal Credit Union DO WITH YOUR PERSONAL INFORMATION?</caption>
                              <thead>
                                <tr>
                                  <th scope="col"><strong>FACTS</strong></th>
                                  <th scope="col"><strong>WHAT DOES JEKO Federal Credit Union DO WITH YOUR PERSONAL INFORMATION?</strong></th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td>All financial companies need to share customers' personal information to run their everyday business. In the section below, we list the reasons financial companies can share their customers' personal information; the reasons Jeko Credit Federal Union (JEKOCFU) chooses to share; and whether you can limit this sharing.</td>
                                </tr>
                              </tbody>
                            </table>
                            <p> </p>
                            ...
                            <table border="1" cellpadding="1" cellspacing="1" class="unstriped" role="presentation">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>Call toll free (447)-774-844-796</td>
                                </tr>
                              </tbody>
                            </table>
                             
                            ...
                            <table border="1" cellpadding="1" cellspacing="1" class="unstriped" role="presentation">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>Jeko Credit Federal Union (JEKOCFU) means the following institutions: Jeko Credit Federal Union (JEKOCFU) and Trust Company and Unity Insurance Partners.</td>
                                </tr>
                              </tbody>
                            </table>
                            <p> </p>
                            ...
                            <table border="1" cellpadding="1" cellspacing="1" class="unstriped" role="presentation">
                              ...
                              <tbody>
                                <tr>
                                  <th class="th-gray text-left vertical-align-top" scope="row" style="width:20%">How does Jeko Credit Federal Union (JEKOCFU) protect my personal information?</th>
                                ...
                                <tr>
                                  <th class="th-gray text-left vertical-align-top" scope="row" style="width:20%">How does Jeko Credit Federal Union (JEKOCFU) collect my personal information?</th>
                                  <td>
                              ...
                              <tbody>
                                  ...
                                  <td>
                                    ...
                                    <ul>
                                      <li>Our affiliates include:
                                        <ul>
                                          <li>Financial companies such as: Finotta, Exencial Wealth Management, and Jeko Credit Federal Union (JEKOCFU) Insurance Solutions, Inc.</li>
                                        </ul>
                                      </li>
                                    </ul>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <ul>
                                      <li>Jeko Credit Federal Union (JEKOCFU) does not share with nonaffiliates so they can market to you.</li>
                                    </ul>
                                  </td>
                                </tr>
                                <tr>
                              ...
                              <ul class="accordion" data-responsive-accordion-tabs="accordion" data-multi-expand="false" data-allow-all-closed="true">
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item" data-q2-deep-link-id="first-united-bank--online-privacy-policy-1261">
                                  <a href="#" class="accordion-title">
                                    <h2>
                                      Jeko Credit Federal Union (JEKOCFU) - ONLINE PRIVACY POLICY
                                    </h2>
                                  </a>
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">

                                      <p>This Online privacy policy governs the manner in which Jeko Credit Federal Union (JEKOCFU) collects, uses, maintains and discloses information collected from users (each, a "User") of the http://www.firstunitedbank.com website ("Site"). This online privacy policy applies to the Site and all products and services offered through the Site by Jeko Credit Federal Union (JEKOCFU).</p>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="how-we-use-collected-information-1265">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>Jeko Credit Federal Union (JEKOCFU) may collect and use Users personal information for the following purposes:</p>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="permissions-our-banking-app-may-request-2592">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>The Jeko Credit Federal Union (JEKOCFU) online banking app may ask for permission to access the following:</p>
                      ...
                      <div class="q2-section general-section gutter-both ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="privacy-policy">
                            ...
                            <p>Moderation of Jeko Credit Federal Union (JEKOCFU)'s Social Media pages will be conducted on an ongoing basis.</p>
                            ...
                            <p>We do not endorse third-party links that appear on this site. Also, comments posted do not represent the opinions of Jeko Credit Federal Union (JEKOCFU).&nbsp;</p>
                            ...
                            <p>Facebook and other social media platforms are owned and operated by a third party not affiliated with Jeko Credit Federal Union (JEKOCFU).&nbsp;</p>
