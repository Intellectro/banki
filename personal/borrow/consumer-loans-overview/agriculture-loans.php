...
<head>
  ...
  <title>Agriculture Loans³ | Jeko Credit Federal Union (JEKOCFU)</title>
        ...
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/ag-loans-internal3.jpg?VersionId=rNn8sY7NuB9dj9A7LyTMrArlkjTPXoma); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">
              ...
              <p>Jeko Credit Federal Union (JEKOCFU) can make joint financing arrangements with Farm Service Agency to make 50/50, 50/45/5, and Guaranteed loans for the purchase of farm/ranch real estate.</p>
                        ...
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="loans">
                            <div class="section-summary">
                              <p>Operating a successful farm or ranch requires a financial partner who understands your business. Jeko Credit Federal Union (JEKOCFU) is that partner, with over 100 years of serving the farming and ranching industry.<br />
                                <br />
