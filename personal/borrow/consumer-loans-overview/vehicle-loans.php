...
<head>
  ...
  <title>Vehicle Loans¹ | Jeko Credit Federal Union (JEKOCFU)</title>
                    ...
                    <div>
                        ...
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <p class="text-center">Jeko Credit Federal Union (JEKOCFU) can help make your vehicle purchase simple with a variety of easy financing options, whether you're buying new or used, or from a dealer or a private seller.</p>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <p class="text-center">Jeko Credit Federal Union (JEKOCFU) offers competitive rates and terms, as well as financing options! We can create a repayment plan with hassle-free terms to make your vehicle purchase simple. In addition, we offer great financing options for refinancing an existing loan.</p>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <p class="text-center">Buying a new or used car, truck or recreational vehicle doesn't have to be a hassle. Visit with a Jeko Credit Federal Union (JEKOCFU) lending specialist who can create an affordable payment plan with hassle-free terms today.</p>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          ...
                          <a href="./auto-loans-faq" class="button" aria-label="Get answers by going to our Vehicle loans FAQ page. ">Get Answers</a>
