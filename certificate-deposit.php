...
<head>
  ...
  <link rel="canonical" href="certificate-deposit.php" />
  ...
  <link rel="alternate" hreflang="en" href="certificate-deposit.php" />

  <title>Certificate of Deposit (CD) | Jeko Credit Federal Union (JEKOCFU)</title>
...
<body class="path-certificate-deposit path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cds-internal.png?VersionId=mRzWF_iZG8nrsXVdpTqHqlab9zqoB8yo); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">
              ...
              <p>A certificate of deposit (CD) is a low-risk investment that may offer you a better return on your money
                ...
                you to learn more by speaking with a Jeko Credit Federal Union (JEKOCFU)er. </p>
                    ...
                    <div>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          ...
                          <a href="./cdoffer" class="button" aria-label="Learn more by going to our CD Offer page">Learn More</a>
                        ...
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p><br />
                              ...
                              (CD)&nbsp;from Jeko Credit Federal Union (JEKOCFU) may be right for you. We offer competitive rates
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/callout-getstarted-2.png?VersionId=Ecx_1uPKk9Cv3ztpO3KMiN73vGEAkn8E" width="362" height="500" alt="Couple on the computer together" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/callout-0monthly-copy.png?VersionId=62OvD99shJyJ4po_MPSBVcgPQcn9ZkOo" width="362" height="500" alt="Happy senior man on laptop" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/callout-onlinemobilebanking-copy.png?VersionId=.7s2G5ZIa4jXcm2nWzEHdEfpAta.3zSE" width="362" height="500" alt="Happy woman on laptop" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-5">
                              ...
                              <div class="button-container">
                                ...
                                <a href="locations.php" class="cd2 button" aria-label="START HERE by going to the locations page. ">START HERE</a>
                      ...
                      <div class="q2-section v-tabs-section grey gutter-both">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="section-summary">
                              <p>Jeko Credit Federal Union (JEKOCFU) is a financial services organization dedicated to
                            ...
                            <div class="cell small-12 v-tabs">
                              <ul class="v-tabs vertical" data-responsive-accordion-tabs="accordion medium-tabs large-tabs" data-multi-expand="false" data-allow-all-closed="true">
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item" data-q2-deep-link-id="driven-by-value-484">
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="holistic-approach-485">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="culture-of-care-486">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                            ...
                            <div class="cell small-12 medium-8">
                              ...
                              <div id="slw-section">
                                ...
                                <p>This "Retirement Planning for Later in Life" webinar was recorded by the Financial
                                  Well-Being team at Jeko Credit Federal Union (JEKOCFU) - Jennifer Henagar, Director of
                              ...
                              <div class="button-container">
                                ...
                                <a href="./spendlifewisely/retirement-planning-later-life-webinar" class="button" aria-label="FINANCIAL WELL BEING">FINANCIAL WELL BEING</a>
                      ...
                      <div class="q2-section general-section gutter-both grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="disclosure">
                            <p>*&nbsp; Compared to the current rate for a Jeko Credit Federal Union (JEKOCFU) 12-Month
                            ...
                            <p>3&nbsp; Annual Percentage Yield (APY) is effective as of August 24, 2022, and subject to
                              ...
                              opening deposit amount must be “new money” to Jeko Credit Federal Union (JEKOCFU). New
                              money is defined as funds not deposited with Jeko Credit Federal Union (JEKOCFU) within
