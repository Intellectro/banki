...
<head>
  ...
  <title>Treasury Management for Business Banking | Jeko Credit Federal Union (JEKOCFU)</title>
                        ...
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              ...
                              <p>Put money in your account without leaving the building. Deposit checks with Remote Deposit Capture and accept credit or debit cards at the point of sale using Jeko Credit Federal Union (JEKOCFU) Merchant Services.</p>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              ...
                              <p>Protect the business you have worked so hard to build. Jeko Credit Federal Union (JEKOCFU) offers multi-factor authentication along with a full suite of fraud prevention tools to help protect your accounts from paper and electronic fraud.</p>
