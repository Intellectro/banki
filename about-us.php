...
<head>
  ...
  <title>About Us - Our Purpose, Values &amp; Vision | Jeko Credit Federal Union (JEKOCFU)</title>
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        <!-- Nav Here -->
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/about-us2-internal.png?VersionId=3dAQIpvpaHJV84AL0ZDd3Z0tQDkQd968); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">
              <h1> About Us</h1>
              <p>Jeko Credit Federal Union (JEKOCFU) is not your typical bank. We are driven by a higher purpose and guided by a
                    ...
                    <div>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            <div class="cell small-12 medium-4">
                              ...
                              <div class="align-center media-image">
                                ...
                                <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/fubt-shield-large-ourpurpose-copy.png?VersionId=nXxjJipKUF37NI2x6FRnAa0.XR0l7Jzb" width="320" height="364" alt="FUB shield large Our Purpose" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              </div>
                          ...
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="cell small-12 ">
                              <ul class="tabs" data-responsive-accordion-tabs="accordion medium-tabs large-tabs" data-multi-expand="false" data-allow-all-closed="true">
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item" data-q2-deep-link-id="extending-love.-835">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/accordian_extending-love-copy.png?VersionId=ZW4fks8J2R_zkQNnK25zHsvct5AYY3Ab" alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <div class="text-center" id="about-us-values"><i class="fas fa-heart fa-2x blue">&nbsp;</i>
                                        ...
                                        <h4 class="MsoNormal" style="line-height: 150%;"><span lang="EN">INTEGRITY</span></h4>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="making-an-impact.-836">
                                  <a href="#" class="accordion-title">
                                    <h2>
                                      Making an IMPACT.
                                    </h2>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/accordian_making-an-impact2-copy.png?VersionId=fmZ.WK8ypJpTHAPmzPfy1qQFJ9gwKuyU" alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <div class="text-center" id="about-us-values"><i class="fas fa-book-reader fa-2x orange">&nbsp;</i>
                                        <h4 class="MsoNormal orange" style="line-height: 150%;"><span lang="EN">LEARNERS</span></h4>
                                        ...
                                        <h4 class="MsoNormal orange" style="line-height: 150%;"><span lang="EN">SERVICE</span></h4>
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_10millionlives-copy.png?VersionId=KaM9kGNWsUcPuHVOibQI9ILNQZ7IUrS8" width="270" height="229" alt="Diverse headshot collage of people smiling" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/cards_customerexperience.png?VersionId=ey5vT.VyUBMZX5op91YfYMO2jmEO5oCR" width="270" height="229" alt="Hand holding a heart " loading="lazy" typeof="foaf:Image" class="img-fluid" />
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/cards_communityflourish.png?VersionId=Ulpz3wx1wmDcey2Lz_kKjej1wMEKUILY" width="270" height="229" alt="Shadows of group of people holding hands held high in the sun" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                          ...
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="cell small-12 ">
                              <ul class="tabs" data-responsive-accordion-tabs="accordion medium-tabs large-tabs" data-multi-expand="false" data-allow-all-closed="true">
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item" data-q2-deep-link-id="faith-830">
                                  <a href="#" class="accordion-title">
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="financial-well-being-831">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="health-832">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="growth-833">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                            ...
                            <div class="button-container">
                              ...
                              <a href="spendlifewisely.php" class="button" aria-label="Spend Life Wisely blog page">Spend Life Wisely</a>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                                ...
                                <div class="statement">
                                  <div class="section-summary">
                                    <p>The <span class="blue">employees</span>, <span class="blue">customers</span>,
                                      ...
                                      <span class="blue">partners</span> who contribute to our shared success.
                                    </p>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="cell small-12 medium-4">
                              ...
                              <div class="align-center media-image" id="stakeholder-tree">
                                ...
                                <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/stakeholder-tree-image-solid-copy.png?VersionId=CRP4JSLUO1EhvU5mLhgtE.._1GGlM.pi" width="2250" height="2283" alt="blue stakeholder tree" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              </div>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          ...
                          <a href="/" class="button">Annual Report</a>
