...
<head>
  ...
  <title>Jeko Credit Federal Union (JEKOCFU) - Checking Accounts, Mortgages, Loans &amp; More</title>
              ...
              <ul class="orbit-container">
                ...
                <li class="orbit-slide">
                  <figure class="orbit-figure">
                    <div class="orbit-image" style="background-image: url('./bglogo.jpg'); background-position: 50% 50%;"></div>
                    <figcaption class="orbit-caption">
                      <div class="shield-title">
                        <img class="banner-shield" alt="Jeko Credit Federal Union (JEKOCFU) red shield logo" src="sites/default/themes/firstunitedbank-com/images/shield-red.svg" />
                        <h2>Welcome To <span style="color: #A6B6CE">Jeko Finance Limited</span></h2>
                      </div>
                      <div class="smart-search">
                        ...
                        <ul class="banner-list">
                          <li>
                            ...
                            <a href="./user/signup.php" rel="nofollow">Start a Mortgage</a>
                        ...
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              ...
                              <a href="/" rel="nofollow" class="button" aria-label="Start here by going to our mortgage page. ">START HERE</a>
