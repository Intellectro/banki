...
<head>
  ...
  <title>Careers &amp; Jobs - Join Our Team | Jeko Credit Federal Union (JEKOCFU)</title>
        ...
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/careerpagev2-internal.png?VersionId=C53VyQG7rIOpDRyIyEj97joWgcmhWzdl); background-position: 50% 50%;">
          <div class="grid-container">
            ...
            <div class="banner-button">
              ...
              <a href="#" target="_blank" rel="nofollow" class="button" aria-label="Start here by going to our Jeko Credit Federal Union (JEKOCFU) Career Site">Start Here</a>
                    ...
                    <div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    ...
                                    <div class="accordion-tab-content">
                                      ...
                                      <div class="careers-tab">
                                        ...
                                        <p><a aria-label="Jeko Credit Federal Union (JEKOCFU) Career Site" class="explore" href="#" rel="nofollow" target="_blank" title="Jeko Credit Federal Union (JEKOCFU) Career Site">Explore Opportunities</a></p>
                                      </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    ...
                                    <div class="accordion-tab-content">
                                      ...
                                      <div class="careers-tab">
                                        ...
                                        <p><a aria-label="Jeko Credit Federal Union (JEKOCFU) Career Site" class="explore" href="#/7/refreshFacet/318c8bb6f553100021d223d9780d30be" rel="nofollow" target="_blank" title="Jeko Credit Federal Union (JEKOCFU) Career Site">Explore Opportunities</a></p>
                                      </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    ...
                                    <div class="accordion-tab-content">
                                      ...
                                      <div class="careers-tab">
                                        ...
                                        <p><a aria-label="Jeko Credit Federal Union (JEKOCFU) Career Site" class="explore" href="#/16/refreshFacet/318c8bb6f553100021d223d9780d30be" rel="nofollow" target="_blank" title="Jeko Credit Federal Union (JEKOCFU) Career Site">Explore Opportunities</a></p>
                                      </div>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-5">
                              ...
                              <div class="button-container">
                                ...
                                <a href="#" target="_blank" rel="nofollow" class="button" aria-label="See all jobs on our Jeko Credit Federal Union (JEKOCFU) Career Site">See all jobs</a>
                      ...
                      <div class="q2-section general-section gutter-both ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="align-right"><a aria-label="Jeko Credit Federal Union (JEKOCFU) LinkedIn Page" class="button" href="https://www.linkedin.com/company/firstunitedbank/" rel="nofollow" role="button" target="_blank" title="Jeko Credit Federal Union (JEKOCFU) LinkedIn Page">Follow Us</a></div>
                        ...
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 column">
                              ...
                              <a href="./spendlifewisely/coffee-chat-aaron-frydman-first-united-bank" class="button" aria-label="A coffee chat with Aaron Frydman at Jeko Credit Federal Union (JEKOCFU) blog">A coffee chat with Aaron Frydman at Jeko Credit Federal Union (JEKOCFU)</a>
                            ...
                            <div class="cell small-12 medium-6 column">
                              ...
                              <a href="./spendlifewisely/grow-your-career-wisely" class="button" aria-label="Grow Your Career Wisely blog">Grow Your Career Wisely </a>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                              ...
                              <div aria-label="Learn more about our 401(k) Match" class="reveal" data-reveal="" id="details-modal1">
                                <div class="row">
                                  <div class="small-12 large-10 large-centered columns text-center">&nbsp;
                                    <p>Jeko Credit Federal Union (JEKOCFU) will match 50% of employee monthly contribution up to 6% of monthly salary. Bank stock may be purchased with 401(k) money.</p>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              ...
                              <div aria-label="Learn more about our Medical benefits" class="reveal" data-reveal="" id="details-modal3">
                                <div class="row">
                                  <div class="small-12 large-10 large-centered columns text-center">&nbsp;
                                    <p>Jeko Credit Federal Union (JEKOCFU) offers an array of benefits for you and your family including access to Doctors Online, Health Advocate Services, and Teladoc.<br />
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              ...
                              <div aria-label="Learn more about our Dental benefits" class="reveal" data-reveal="" id="details-modal4">
                                <div class="row">
                                  <div class="small-12 large-10 large-centered columns text-center">&nbsp;
                                    <p>Jeko Credit Federal Union (JEKOCFU) provides dental coverage for diagnostic and preventative services.</p>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              ...
                              <div aria-label="Learn more about our Wellness Program" class="reveal" data-reveal="" id="details-modal6">
                                <div class="row">
                                  <div class="small-12 large-10 large-centered columns text-center">&nbsp;
                                    <p>Jeko Credit Federal Union (JEKOCFU) has partnered with Virgin Pulse to provide a top notch wellness program, annual wellness incentives, on-site wellness director, and earn days off throughout the year.</p>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              ...
                              <div aria-label="Learn more about our Educational Reimbursement" class="reveal" data-reveal="" id="details-modal8">
                                <div class="row">
                                  <div class="small-12 large-10 large-centered columns text-center">&nbsp;
                                    <p>Jeko Credit Federal Union (JEKOCFU) provides educational assistance to all eligible full-time employees who have completed one (1) year of service. Jeko Credit Federal Union (JEKOCFU) will reimburse 100% of the costs of tuition, books, and fees for a total of up to $2,000 annually, in an approved academic institution or selected banking school provided the course is related to your current position or a future position you may hold at the bank.</p>
