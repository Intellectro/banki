...
<head>
  ...
  <title>SBA Lending | Jeko Credit Federal Union (JEKOCFU)</title>
                        ...
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-9">
                              ...
                              <h2>Jeko Credit Federal Union (JEKOCFU) is proud to be part of the Small Business Administration (SBA)</h2>
