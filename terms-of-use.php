...
<head>
  ...
  <title>Terms of Use | Jeko Credit Federal Union (JEKOCFU)</title>
                      ...
                      <div class="q2-section general-section gutter-top grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <p>PLEASE READ THESE TERMS AND CONDITIONS CAREFULLY. BY ACCESSING THIS WEBSITE YOU AGREE TO BE
                            ...
                            Unauthorized use of Jeko Credit Federal Union (JEKOCFU) &amp; Trust Company ("First United")
                            ...
                            prohibited.<br />
                            <br />
                            You acknowledge that Jeko Credit Federal Union (JEKOCFU) may disclose and transfer any information
                            that you provide through this Website to (i) any company within the Jeko Credit Federal Union (JEKOCFU) Credit
                      ...
                      <div class="q2-section general-section gutter-bottom grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <p>The works of authorship contained in the firstunitedbank.com Website (the "Website"),
                            ...
                            except as otherwise expressly stated, by Jeko Credit Federal Union (JEKOCFU) or one of its
                          ...
                          <p>Jeko Credit Federal Union (JEKOCFU) is the marketing name for the retail financial services
                            activities of Jeko Credit Federal Union (JEKOCFU) &amp; Trust Company and its subsidiaries
                            and affiliates in the United States. First United, the nested "U and 1" symbol and logo are
                            trademarks of Jeko Credit Federal Union (JEKOCFU) &amp; Trust Company. Other featured words
                          ...
                          <p>The information on this Website is for information purposes only. It is believed to be
                            reliable, but Jeko Credit Federal Union (JEKOCFU) does not warrant its completeness, timeliness or
                            accuracy.<br />
                            <br />
                            ...
                            individuals.<br />
                            <br />
                            Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION OR ITS SUPPLIERS MAY DISCONTINUE OR MAKE CHANGES IN THE
                            ...
                            AND Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION DOES NOT UNDERTAKE ANY OBLIGATION OR RESPONSIBILITY TO UPDATE
                            OR AMEND ANY SUCH INFORMATION. Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION RESERVES THE RIGHT TO TERMINATE ANY
                            ...
                            DISTRIBUTION OR SOLICITATION IS MADE BY Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION TO ANY PERSON TO USE THE
                          ...
                          <p>Links to non-Jeko Credit Federal Union (JEKOCFU) Websites are provided solely as pointers to
                            information on topics that may be useful to the Websites, and Jeko Credit Federal Union (JEKOCFU) has
                            no control over the content on such non-Jeko Credit Federal Union (JEKOCFU) Websites. If you choose to
                            link to a Website not controlled by First United, Jeko Credit Federal Union (JEKOCFU) makes no
                            ...
                            does Jeko Credit Federal Union (JEKOCFU) warrant that such site or content is free from any claims of
                            copyright, trademark or other infringement of the rights of third parties or that such site
                            or content is devoid of viruses or other contamination. Jeko Credit Federal Union (JEKOCFU) does not
                            guarantee the authenticity of documents on the Internet. Links to non-Jeko Credit Federal Union (JEKOCFU) Credit
                          ...
                          <p>BECAUSE OF THE POSSIBILITY OF HUMAN AND MECHANICAL ERROR AS WELL AS OTHER FACTORS, THE
                            ...
                            IS" "AS AVAILABLE". Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION AND THIRD PARTY DATA PROVIDERS ARE NOT
                            PROVIDING ANY WARRANTIES AND REPRESENTATIONS REGARDING THE WEBSITE. Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT
                            ...
                            FITNESS FOR ANY PARTICULAR PURPOSE. FURTHER, Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION WILL NOT BE LIABLE
                            ...
                            FILES AND THE USER'S BROWSER OR OTHER SITE ACCESSING PROGRAM. NOR WILL Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT
                            UNION BE LIABLE FOR ANY OTHER PROBLEMS EXPERIENCED BY THE USER DUE TO CAUSES BEYOND Jeko Credit Federal Union (JEKOCFU)
                            FEDERAL CREDIT UNION 'S CONTROL. NO LICENSE TO THE USER IS IMPLIED IN THESE
                            DISCLAIMERS.<br />
                            <br />
                            Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION AND THIRD PARTY DATA PROVIDERS DO NOT WARRANT THE ACCURACY,
                            ...
                            FURTHERMORE, Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION AND ITS AFFILIATES WILL NOT BE LIABLE FOR ANY DELAY,
                            ...
                            Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION AND ITS AFFILIATES' CONTROL. NO LICENSE TO THE USER IS IMPLIED IN
                            THESE DISCLAIMERS. NOTHING HEREIN SHALL BE CONSTRUED AS LIMITING OR REDUCING Jeko Credit Federal Union (JEKOCFU) FEDERAL
                            CREDIT UNION 'S RESPONSIBILITIES AND OBLIGATIONS TO CLIENTS IN ACCORDANCE WITH APPLICABLE
                            LAWS AND REGULATIONS.<br />
                            <br />
                            UNDER NO CIRCUMSTANCES WILL Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION BE LIABLE FOR ANY LOST PROFITS, LOST
                            ...
                            REGARDLESS OF WHETHER Jeko Credit Federal Union (JEKOCFU) FEDERAL CREDIT UNION HAS BEEN APPRISED OF THE LIKELIHOOD OF SUCH
