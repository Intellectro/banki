...
<head>
  ...
  <title>Life Insurance | Jeko Credit Federal Union (JEKOCFU)</title>
  <link rel="stylesheet" media="all" href="./modules/contrib/webform/css/webform.element.flexbox.css?ro3e14" />
  ...
  <link rel="stylesheet" media="all" href="./modules/contrib/webform/css/webform.form.css?ro3e14" />
  <link rel="stylesheet" media="all" href="./modules/contrib/webform/css/webform.element.details.toggle.css?ro3e14" />
  <link rel="stylesheet" media="all" href="./modules/contrib/webform/css/webform.element.message.css?ro3e14" />
  <link rel="stylesheet" media="all" href="./modules/contrib/antibot/css/antibot.css?ro3e14" />
  <link rel="stylesheet" media="all" href="./modules/contrib/webform/css/webform.element.horizontal_rule.css?ro3e14" />
...
<body class="path-insurance-personal-insurance-life-insurance path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
          ...
          <div class="cell auto oc-aux small-order-1">
            <div>
              <div id="block-auxnav">
                ...
                <ul>
                  <li><a aria-label="Community Bank Locations" data-entity-substitution="canonical" data-entity-type="node" data-entity-uuid="2a975d0a-12a6-49af-9f74-78cc0ea22229" href="../../locations.php" title="locations"><i class="fas fa-map-marker-alt"> </i> Locations</a>
                  </li>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        ...
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/life-insurance-internal.png?VersionId=iJ2UC5.QkBsaPdKvYI.txqBXO89tE6hu); background-position: 50% 50%;">
                    ...
                    <div>
                        ...
                        <div class="global-width grid-x grid-margin-x grid-margin-y">
                          <div class="cell small-12  medium-6">
                            ...
                            <div class="q2-section grid-section cards gutter-none" id="insurance-service">
                              <div class="cell small-12 card no-image">
                                <p>Jeko Credit Federal Union (JEKOCFU) Insurance Solutions offers an easy and affordable Final
                          ...
                          <div class="webform-container cell small-12 medium-6">
                            ...
                            <form class="webform-submission-form webform-submission-add-form webform-submission-insurance-sign-up-form-form webform-submission-insurance-sign-up-form-add-form webform-submission-insurance-sign-up-form-paragraph-1508-form webform-submission-insurance-sign-up-form-paragraph-1508-add-form general-insurance-wb js-webform-details-toggle webform-details-toggle antibot" data-drupal-selector="webform-submission-insurance-sign-up-form-paragraph-1508-add-form" data-action="/insurance/personal-insurance/life-insurance" action="./antibot" method="post" id="webform-submission-insurance-sign-up-form-paragraph-1508-add-form" accept-charset="UTF-8">
                              ...
                              <input autocomplete="off" data-drupal-selector="form-w-o7zqh4fcorqynmwua-zei8ur5vd8fsxaui4xp9ng" type="hidden" name="form_build_id" value="form-w_-O7Zqh4FcorqYNMwUA_zEI8UR5vD8fSxaUi4XP9Ng" />
                              <input data-drupal-selector="edit-webform-submission-insurance-sign-up-form-paragraph-1508-add-form" type="hidden" name="form_id" value="webform_submission_insurance_sign_up_form_paragraph_1508_add_form" />
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          ...
                          <a href="./insurance/personal-insurance/life-insurance/faq" class="button" aria-label="Life Insurance Frequently Asked Questions page">Get Answers</a>
                ...
                <div>
                  <div id="block-copyright">
                    ...
                    <ul>
                      ...
                      <li><a data-entity-substitution="canonical" data-entity-type="node" data-entity-uuid="9a48544f-4c08-434d-9849-bcc40f77b8f2" href="../../accessibility-statement.php" title="Accessibility Statement">Accessibility
                          Statement</a></li>
                    </ul>
                    <p>©
                      <script>
  ...
  <script type="application/json" data-drupal-selector="drupal-settings-json">
    {
      ...
      "antibot": {
        "forms": {
          "webform-submission-insurance-sign-up-form-paragraph-1508-add-form": {
            "id": "webform-submission-insurance-sign-up-form-paragraph-1508-add-form",
            "key": "gnVTui0_Z-GzYdzbkvDF0Fn4hhd_7aObhYC1LDPzGMk"
          }
        }
      },
  ...
  <script src="../../modules/contrib/antibot/js/antibot.js?ro3e14"></script>
