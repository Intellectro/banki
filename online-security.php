...
<head>
  ...
  <title>Online Security | Jeko Credit Federal Union (JEKOCFU)</title>
        ...
        <div class="internal-page-banner">
          <div class="grid-container">
            ...
            <div class="banner-button">
              <p>Suspicious or unusual activity related to any of your accounts? Call us at (447)-774-844-796. </p>
                    ...
                    <div>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <p class="message">Jeko Credit Federal Union (JEKOCFU) and its affiliates will not send our customers emails or written correspondence asking for personal information such as your customer account number, password, personal identification number (PIN), or other personal information. Furthermore, Jeko Credit Federal Union (JEKOCFU) and its affiliates will not telephone you to request personal or account information. To further protect your personal and account information, Jeko Credit Federal Union (JEKOCFU) and its affiliates will use information from your account to verify your identity if you call us.</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                      ...
                      <div class="q2-section general-section gutter-both grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <p>If you receive an email, written correspondence or telephone call requesting your personal or account information from an individual, company or organization that claims to be from Jeko Credit Federal Union (JEKOCFU) or its affiliates, contact us immediately at <strong>(447)-774-844-796</strong>.<br />
                            <br />
                            While Jeko Credit Federal Union (JEKOCFU) works to protect your banking privacy, you will also play an important role in protecting your accounts. There are a number of steps you can take to ensure that your Online Banking account information is protected:
                          </p>
                          ...
                          <ul>
                            ...
                            <li>If you notice any suspicious or unusual activity related to any of your accounts, contact us immediately at <strong>(447)-774-844-796</strong>.</li>
                          </ul>
                      ...
                      <div class="q2-section accordion-section blue-pattern-top gutter-both">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="section-summary">
                              <p>Jeko Credit Federal Union (JEKOCFU) and Trust Company is committed to making your Online Banking experience safe and secure. We have taken many measures to ensure your privacy, including: </p>
                            </div>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="personally-selected-account-names-1286">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>Jeko Credit Federal Union (JEKOCFU) &amp; Trust Company does not display your account numbers over the Internet. Instead, we ask you to choose a "pseudo" name for each of your accounts.</p>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="individual-id-&amp;-pin-information-1287">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>In order to access Jeko Credit Federal Union (JEKOCFU) &amp; Trust Company's Online Banking, you must enter a unique User ID and PIN.</p>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="firewalls-1291">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>Jeko Credit Federal Union (JEKOCFU) uses an encrypted network to communicate data between the customer and the bank. We are monitoring communication 24 hours a day.</p>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="multi-factor-authentication-1292">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>Jeko Credit Federal Union (JEKOCFU) uses multi-factor authentication in order to help you safeguard access to your accounts in the event your password and login are compromised. The first time you logon from a new device or browser, you will be prompted to provide an out-of-band authentication code that is delivered to you via an SMS text message or an automated voice call. These one-time access codes are only valid for 15 minutes are used to ensure only you have access to your accounts online.</p>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <ul>
                                        ...
                                        <li>Contact&nbsp;<em>Jeko Credit Federal Union (JEKOCFU) Customer Service at <strong>(447)-774-844-796</strong></em>&nbsp;if you notice any suspicious or unusual activity related to your Online Banking, or if you lose your mobile device or change your phone number.</li>
                                      </ul>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="things-to-avoid-if-you-suspect-you-are-being-phished-1297">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>Avoid replying to emails that look suspicious, or that ask for personal information such as your Social Security Number, account number, or password. Representatives of Jeko Credit Federal Union (JEKOCFU) will never ask you to confirm your password.</p>
